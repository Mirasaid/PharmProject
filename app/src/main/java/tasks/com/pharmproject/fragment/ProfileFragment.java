...
import tasks.com.pharmproject.DB.DBHelper;
import tasks.com.pharmproject.R;
import tasks.com.pharmproject.model.UserInformation;
import tasks.com.pharmproject.model.adapter.ProfilePostsAdapter;
import tasks.com.pharmproject.util.Utility;
...
public class ProfileFragment extends Fragment {
    ...
    ValueEventListener userInformationListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            if (dataSnapshot != null) {
                ...
                saveAndReviewUserTnformation(userInformation);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        imageViewProfilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (textViewProfilePic.getText().equals("")) {
                    viewProfilePic();
                } else {
                    Toast.makeText(getContext(), "you haven't set photo yet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void initView() {
        imageViewProfilePic = (ImageView) rootView.findViewById(R.id.profile_pic);
        textViewProfilePic = (TextView) rootView.findViewById(R.id.txt_profile_pic);
        textViewUserName = (TextView) rootView.findViewById(R.id.txt_name);
        textViewUserEmail = (TextView) rootView.findViewById(R.id.txt_email);
        textViewUserPhone = (TextView) rootView.findViewById(R.id.txt_phone);
        textViewUserCity = (TextView) rootView.findViewById(R.id.txt_city);
        mTextViewNoPostsProfile = (TextView) rootView.findViewById(R.id.txt_no_posts_profile);
        mRecyclerViewPostsProfile = (RecyclerView) rootView.findViewById(R.id.recycle_my_posts);
        progressBar = (ProgressBar) rootView.findViewById(R.id.progressbar_profile);
        btnEditPic = (Button) rootView.findViewById(R.id.btn_edit_image);
    }
    ...
    @SuppressLint("SetTextI18n")
    void saveAndReviewUserTnformation(final UserInformation userInformation) {
...
//                        imageViewProfilePic.setImageBitmap(response);
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP_MR1)
    void viewProfilePic() {
        final Dialog nagDialog = new Dialog(getActivity(), android.R.style.Theme_DeviceDefault_Light_Dialog);
